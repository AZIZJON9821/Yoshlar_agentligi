...
// import agencyImage from "@/public/images/agency.jpg"; // Sizning agentlik rasmi

const AboutAgencyPage: React.FC = () => {
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <h1 className={styles.title}>O‘zbekiston Respublikasi Yoshlar ishlari agentligi</h1>
        
        {/* <img src={agencyImage.src} alt="Agentlik rasmi" className={styles.image} /> */}
